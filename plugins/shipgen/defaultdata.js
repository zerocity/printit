...
module.exports = {
    ships: [
        {name: 'hamdar', slug: 'hamdar', published: true, desc: 'hamdar is a small well rounded fighter class ship capable of handling almost anything averagely.', size: 1, class: 'fighter', type: 'common'},
        {name: 'tiamat', slug: 'tiamat', published: true, desc: 'the tiamat is a fast but vulnerable ship capable of hitting and retreating.', size: 1, class: 'fighter', type: 'charge'},
